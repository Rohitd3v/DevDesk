...
function TicketDetailContent() {
  ...
  const [syncStatus, setSyncStatus] = useState<{ synced: boolean; sync_data?: any } | null>(null);
      ...
      <div className="bg-white rounded-xl border p-6 shadow-sm mb-6">
        <div className="flex flex-col md:flex-row md:items-start justify-between mb-4 gap-4">
          ...
          <div className="flex gap-2 items-center flex-wrap">
            {syncStatus?.synced && syncStatus.sync_data?.github_linked_repos?.html_url && (
              <a
                href={`${syncStatus.sync_data.github_linked_repos.html_url}/issues/${syncStatus.sync_data.github_issue_number}`}
                target="_blank"
              ...
              >
                ...
                #{syncStatus.sync_data.github_issue_number}
              </a>
            )}
